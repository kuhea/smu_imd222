...
function setup() {
  ...
  boundaries.push(new Rect(400, 650, 810, 60, { isStatic: true }));
  boundaries.push(new Rect(900, 800, 1000, 60, { isStatic: true }));

  matterObjs.push(
    new Rect(200, 150, 50, 50, {
      restitution: 1,
      friction: 0,
      frictionAir: 0,
      frictionStatic: 0,
  ...
  // );
  matterObjs.push(
    new Circle(950, 300, random(20, 50), {
      restitution: 1,
      friction: 0,
      frictionAir: 0,
      frictionStatic: 0,
  ...
  let body6 = new P5Circle(800, 20, 20);
  matterBodies.push(body6);
  ...
  let body8 = new P5Polygon(100, 300, 3, 50, {
    restitution: 1,
    friction: 0,
    frictionAir: 0,
    frictionStatic: 0,
  });
  matterBodies.push(body8);
  ...
  let body9 = new P5Polygon(100, 300, 3, 100, {
    restitution: 1,
    friction: 0,
    frictionAir: 0,
    frictionStatic: 0,
  });
  matterBodies.push(body9);
  let constraint9 = new P5Constraint({
    pointA: { x: 400, y: 0 },
    bodyB: body9.getBody(),
    length: 0,
  });
  matterConstraints.push(constraint9);
